...
export PATH=$HOME/.nodebrew/current/bin:$HOME/.node_global/bin:/$HOME/.nodenv/shims:usr/local/opt/gettext/bin:$GOPATH/bin:$HOME/.pyenv/shims:/usr/local/opt/php@7.2/bin:$HOME/.composer/vendor/bin:/usr/local/bin:/usr/bin:$PATH
